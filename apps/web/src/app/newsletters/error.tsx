...
export default function NewslettersError({
    ...
    useEffect(() => {
        logger.error({ msg: 'Newsletters page error', error: error.message, stack: error.stack, digest: error.digest });
    }, [error]);
            ...
            <div className="max-w-md w-full bg-white border border-[#DCDCDC] rounded-lg p-8 text-center">
                <div className="mb-6">
                    ...
                    <p className="text-[#727272]">
                        We couldn't load the newsletters list. This might be a temporary issue.
                    </p>
                </div>
